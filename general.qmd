...
Fundamentally, I believe that use of AI tools **in this class** errodes the practice of learning.[Note that these AI policies apply only to this course. For your other courses, please follow those professors' AI policies, which may differ from mine.]{aside}

For full transparency, you should know that I have strong feelings about AI use in general, most of which are touched upon by this passage from Anthony Moser's essay ["I Am An AI Hater"](https://anthonymoser.github.io/writing/ai/haterdom/2025/08/26/i-am-an-ai-hater.html)
